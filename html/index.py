                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-xs-6" style="text-align:right">
                                <h5><span id="balance">0.0000000</span> <small>SOLACE</small> <span class="syncing"> (syncing)</span></h5>
                                <h5><span id="unlocked_balance">0.0000000</span> <small>SOLACE</small> <span class="syncing"> (syncing)</span></h5>
                            </div>
